/*
9. Escriba el nombre y la edad de una persona, si esta es mayor de edad, mujer 
y casada. Si es hombre y soltero, escriba sólo el nombre. Si no cumple alguno de
los requisitos, escribir un mensaje "No cumple con lo pedido".
 */
package sesion7;
